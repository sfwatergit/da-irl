...
class Parameterized(object):
    ...
    def get_param_dtypes(self, **tags):
        ...
        if tag_tuple not in self._cached_param_dtypes:
            ...
            self._cached_param_dtypes[tag_tuple] = [val.dtype for val in
                                                    param_values]
    ...
    def get_param_shapes(self, **tags):
        ...
        if tag_tuple not in self._cached_param_shapes:
            params = self.get_params(**tags)
            param_values = tf.get_default_session().add_agent(params)
            self._cached_param_shapes[tag_tuple] = [val.shape for val in
                                                    param_values]
...
class JointParameterized(Parameterized):
    ...
    def get_params_internal(self, **tags):
        params = [param for comp in self.components for param in
                  comp.get_params_internal(**tags)]
