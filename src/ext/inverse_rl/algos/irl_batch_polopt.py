...
class IRLBatchPolopt(RLAlgorithm, metaclass=Hyperparametrized):
    ...
    def __init__(
        ...
        :param scope: Scope for identifying the algorithm. Must be specified
        if running multiple algorithms
        ...
        :param center_adv: Whether to rescale the advantages so that they
        have mean 0 and standard deviation 1.
        :param positive_adv: Whether to shift the advantages so that they are
        always positive. When used in
        conjunction with center_adv the advantages will be standardized
        before shifting.
